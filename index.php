...
$blogPost = $blog -> selectBlogPost($page);

$pagi = $blog -> pagination();
      ...
      <div class="row">
        ...
        ?>
          ...
          <nav aria-label="Page navigation">
            <ul class="pagination">
              <li>
                <a href="index.php?page=<?php $p=($page-1); echo $p; ?>" aria-label="Previous">
              ...
              <?php 
                if($pagi){
                  ...
                  <?php } } ?>
              <li>
                <a href="index.php?page=<?php $p=($page+1); echo $p; ?>" aria-label="Next">

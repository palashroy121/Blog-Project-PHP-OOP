      ...
      <div class="row">
        ...
        ?>
          ...
          <nav aria-label="Page navigation">
            <ul class="pagination">
              <li>
                <a href="css.php?page=<?php $p=($page-1); echo $p; ?>" aria-label="Previous">
              ...
              <?php 
                if($cat_pagi){
                  for($b=1; $b<=$cat_pagi; $b++){ ?>
                    <li><a href="css.php?page=<?php echo $b; ?>"><?php echo $b; ?></a></li>
                  <?php } } ?>
              <li>
                <a href="css.php?page=<?php $p=($page+1); echo $p; ?>" aria-label="Next">
